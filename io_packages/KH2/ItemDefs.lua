...
function ItemDefs:DefineItems()
    items = {
        -- Ansem Reports
        {ID = 226, Name = "Secret Ansem Report 1",  Ability = "false", Address = 0x36C4, Bitmask = 6},
        {ID = 227, Name = "Secret Ansem Report 2",  Ability = "false", Address = 0x36C4, Bitmask = 7},
        {ID = 228, Name = "Secret Ansem Report 3",  Ability = "false", Address = 0x36C5, Bitmask = 0},
        {ID = 229, Name = "Secret Ansem Report 4",  Ability = "false", Address = 0x36C5, Bitmask = 1},
        {ID = 230, Name = "Secret Ansem Report 5",  Ability = "false", Address = 0x36C5, Bitmask = 2},
        {ID = 231, Name = "Secret Ansem Report 6",  Ability = "false", Address = 0x36C5, Bitmask = 3},
        {ID = 232, Name = "Secret Ansem Report 7",  Ability = "false", Address = 0x36C5, Bitmask = 4},
        {ID = 233, Name = "Secret Ansem Report 8",  Ability = "false", Address = 0x36C5, Bitmask = 5},
        {ID = 234, Name = "Secret Ansem Report 9",  Ability = "false", Address = 0x36C5, Bitmask = 6},
        {ID = 235, Name = "Secret Ansem Report 10", Ability = "false", Address = 0x36C5, Bitmask = 7},
        {ID = 236, Name = "Secret Ansem Report 11", Ability = "false", Address = 0x36C6, Bitmask = 0},
        {ID = 237, Name = "Secret Ansem Report 12", Ability = "false", Address = 0x36C6, Bitmask = 1},
        {ID = 238, Name = "Secret Ansem Report 13", Ability = "false", Address = 0x36C6, Bitmask = 2},
        ...
        {ID = 383,Name = "Chicken",   Ability = "false", Address = 0x36C0, Bitmask = 3},
        ...
        {ID = 484, Name = "Heros Crest",      Ability = "false", Address = 0x367F},
        ...
        {ID = 544, Name = "Winners Proof",    Ability = "false", Address = 0x3699},
        {ID = 71, Name = "Pureblood",         Ability = "false", Address = 0x35BF},

        --Staves
        {ID = 546, Name = "Centurion 2",         Ability = "false", Address = 0x369B},
        ...
        {ID = 550, Name = "Precious Mushroom 2", Ability = "false", Address = 0x369F},
        {ID = 551, Name = "Premium Mushroom",    Ability = "false", Address = 0x36A0},
        {ID = 154, Name = "Rising Dragon",       Ability = "false", Address = 0x35F5},
        {ID = 503, Name = "Save the Queen 2",    Ability = "false", Address = 0x3692},
        {ID = 156, Name = "Shamans Relic",       Ability = "false", Address = 0x35F7},

        --Shields
        {ID = 146, Name = "Akashic Record",      Ability = "false", Address = 0x35ED},
        {ID = 553, Name = "Frozen Pride 2",      Ability = "false", Address = 0x36A2},
        {ID = 145, Name = "Genji Shield",        Ability = "false", Address = 0x35EC},
        {ID = 556, Name = "Majestic Mushroom",   Ability = "false", Address = 0x36A5},
        {ID = 557, Name = "Majestic Mushroom 2", Ability = "false", Address = 0x36A6},
        {ID = 147, Name = "Nobody Guard",        Ability = "false", Address = 0x35EE},
        {ID = 141, Name = "Ogre Shield",         Ability = "false", Address = 0x35E8},
        {ID = 504, Name = "Save the King 2",     Ability = "false", Address = 0x3693},
        {ID = 558, Name = "Unltimate Mushroom",  Ability = "false", Address = 0x36A7},

        --Accessories
        {ID = 8, Name = "Ability Ring" ,     Ability = "false", Address = 0x3587},
        {ID = 9, Name = "Engineers Ring" ,   Ability = "false", Address = 0x3588},
        {ID = 10, Name = "Technicians Ring", Ability = "false", Address = 0x3589},
        {ID = 38, Name = "Skill Ring",       Ability = "false", Address = 0x359F},
        {ID = 39, Name = "Experts Ring",     Ability = "false", Address = 0x35A0},
        {ID = 11, Name = "Master Ring",      Ability = "false", Address = 0x358A},
        {ID = 34, Name = "Cosmic Ring",      Ability = "false", Address = 0x359B},
        {ID = 52, Name = "Executive Ring",   Ability = "false", Address = 0x35AD},
        {ID = 599, Name = "Sardonyx Ring",   Ability = "false", Address = 0x36B5},
        {ID = 12, Name = "Tourmaline Ring",  Ability = "false", Address = 0x358B},
        {ID = 13, Name = "Aquamarine Ring",  Ability = "false", Address = 0x358C},
        {ID = 14, Name = "Garnet Ring",      Ability = "false", Address = 0x358D},
        {ID = 15, Name = "Diamond Ring",     Ability = "false", Address = 0x358E},
        ...
        {ID = 40, Name = "Soldiers Earring", Ability = "false", Address = 0x35A6},
        {ID = 46, Name = "Fencer Earing",    Ability = "false", Address = 0x35A7},
        {ID = 47, Name = "Mage Earing",      Ability = "false", Address = 0x35A8},
        {ID = 48, Name = "Slayer Earing",    Ability = "false", Address = 0x35AC},
        ...
        {ID = 58, Name = "Shadow Archive 2", Ability = "false", Address = 0x35B7},
        {ID = 64, Name = "Full Bloom",       Ability = "false", Address = 0x35B9},
        {ID = 66, Name = "Full Bloom 2",     Ability = "false", Address = 0x35BB},
        ...
        {ID = 293, Name = "Thunaga Tinket",    Ability = "false", Address = 0x35E4},
        {ID = 294, Name = "Thundagun Trinket", Ability = "false", Address = 0x35E5},
        {ID = 132, Name = "Shock Charm",       Ability = "false", Address = 0x35D2},
        {ID = 133, Name = "Shock Charm 2",     Ability = "false", Address = 0x35D3},
        {ID = 296, Name = "Shaow Anklet",      Ability = "false", Address = 0x35F9},
        ...
        {ID = 307, Name = "Acrisius 2",        Ability = "false", Address = 0x3605},
...
function ItemDefs:DefineAbilities()
    abilities = {
        ...
        {ID = 403, Name = "Magic Lock",         Ability = "Sora", Address = 0x193},
        ...
        {ID = 199, Name = "Donald Fantasia",       Ability = "Donald", Address = 0x0C7},
        {ID = 200, Name = "Donald Flare Force",    Ability = "Donald", Address = 0x0C8},
        ...
        {ID = 597, Name = "Goofy Protera",        Ability = "Goofy", Address = 0x255},
        {ID = 598, Name = "Goofy Protega",        Ability = "Goofy", Address = 0x256},
    }
    return abilities
end
